...
# `from PyQtX.QtCore import *` raise a type error for autodoc, using pyside
# works fine
...
MOCK_MODULES = ['PyQt4', 'PyQt4.QtCore', 'PyQt4.QtGui', 'PyQt4.QtNetwork',
                'PyQt5', 'PyQt5.QtCore', 'PyQt5.QtGui', 'PyQt5.QtNetwork',
                'PyQt5.QtWidgets']
