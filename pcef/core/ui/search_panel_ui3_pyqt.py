...
class Ui_SearchPanel(object):
    def setupUi(self, SearchPanel):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/pcef-icons/rc/edit-find.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/pcef-icons/rc/edit-find-replace.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
import pcef.core.ui.pcef_icons_rc3_pyqt

class SearchPanel(QtGui.QWidget, Ui_SearchPanel):
