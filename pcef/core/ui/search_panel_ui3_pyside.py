...
#
# Created: Mon Jul  8 15:02:49 2013
...
class Ui_SearchPanel(object):
    def setupUi(self, SearchPanel):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/pcef-icons/rc/edit-find.png"))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/pcef-icons/rc/go-up.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/pcef-icons/rc/go-down.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/pcef-icons/rc/close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label_2.setPixmap(QtGui.QPixmap(":/pcef-icons/rc/edit-find-replace.png"))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/pcef-icons/rc/edit-find.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/pcef-icons/rc/edit-find-replace.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
import pcef.core.ui.pcef_icons_rc3_pyside
