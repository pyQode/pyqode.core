...
#
# Created: Tue Feb 12 10:10:59 2013
...
class Ui_SearchPanel(object):
    def setupUi(self, SearchPanel):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/icons/rc/edit-find.png"))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/rc/go-up.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/rc/go-down.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/rc/close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label_2.setPixmap(QtGui.QPixmap(":/icons/rc/edit-find-replace.png"))
