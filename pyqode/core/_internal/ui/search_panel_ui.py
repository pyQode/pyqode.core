...
class Ui_SearchPanel(object):
    def setupUi(self, SearchPanel):
        ...
        self.labelSearch.setText(_fromUtf8(""))
        self.labelSearch.setPixmap(QtGui.QPixmap(_fromUtf8(":/pycode-icons/rc/edit-find.png")))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/pyqode_icons/rc/go-up.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/pycode-icons/rc/go-down.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/pycode-icons/rc/close.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.labelReplace.setText(_fromUtf8(""))
        self.labelReplace.setPixmap(QtGui.QPixmap(_fromUtf8(":/pycode-icons/rc/edit-find-replace.png")))
